...
validate_recipe_outputs "sagemaker-tensorflow-serving-container-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="sagemaker-tensorflow-serving-container-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi